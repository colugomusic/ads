...
auto read(const data<Chs, Frs>& src, frame_idx start, ml::DSPVectorDynamic* dest) -> frame_count {
...
template <uint64_t Chs, uint64_t Frs>
auto read(const data<Chs, Frs>& src, ml::DSPVectorDynamic* dest) -> frame_count {
	return read(src, frame_idx{0}, dest);
}

template <uint64_t Chs, uint64_t Frs>
	requires (detail::is_mono_data<Chs>)
auto read(const data<Chs, Frs>& src, frame_idx start, ml::DSPVector* dst) -> frame_count {
...
template <uint64_t Chs, uint64_t Frs>
	requires (detail::is_mono_data<Chs>)
auto read(const data<Chs, Frs>& src, ml::DSPVector* dst) -> frame_count {
	return read(src, frame_idx{0}, dst);
}

template <uint64_t Chs, uint64_t Frs>
auto read(const data<Chs, Frs>& src, channel_idx ch, frame_idx start, ml::DSPVector* dst) -> frame_count {
...
template <uint64_t Chs, uint64_t Frs>
auto read(const data<Chs, Frs>& src, channel_idx ch, ml::DSPVector* dst) -> frame_count {
	return read(src, ch, frame_idx{0}, dst);
}

template <uint64_t Chs, uint64_t Frs>
auto write(data<Chs, Frs>* dst, frame_idx start, const ml::DSPVectorDynamic& src) -> frame_count {
...
template <uint64_t Chs, uint64_t Frs>
auto write(data<Chs, Frs>* dst, const ml::DSPVectorDynamic& src) -> frame_count {
...
template <uint64_t Chs, uint64_t Frs>
	requires (detail::is_mono_data<Chs>)
auto write(data<Chs, Frs>* dst, const ml::DSPVector& signal) -> frame_count {
	return write(dst, frame_idx{0}, signal);
}

template <uint64_t Chs, uint64_t Frs>
auto write(data<Chs, Frs>* dst, channel_idx ch, frame_idx start, const ml::DSPVector& signal) -> frame_count {
...
template <uint64_t Chs, uint64_t Frs>
auto write(data<Chs, Frs>* dst, channel_idx ch, const ml::DSPVector& signal) -> frame_count {
	return write(dst, ch, frame_idx{0}, signal);
}

template <uint64_t Chs, uint64_t Frs, size_t ROWS>
auto write(data<Chs, Frs>* dst, frame_idx start, const ml::DSPVectorArray<ROWS>& signal) -> frame_count {
...
template <uint64_t Chs, uint64_t Frs, size_t ROWS>
auto write(data<Chs, Frs>* dst, const ml::DSPVectorArray<ROWS>& signal) -> frame_count {
	return write(dst, frame_idx{0}, signal);
}
